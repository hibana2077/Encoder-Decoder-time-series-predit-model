...
LastEditTime: 2024-05-16 23:57:38
...
args.add_argument('--from_date', type=str, default='2023-01-01 00:00:00')
args.add_argument('--to_date', type=str, default='2024-01-01 00:00:00')
...
if __name__ == '__main__':
    ...
    while since < exchange.parse8601(to_date):
        logger.info(f'Now Since: {exchange.iso8601(since)}')
